...
function DetailsPage() {
    ...
    return (
        <div className="flex w-full min-h-screen bg-[#F8FAFC] dark:bg-neutral-950 text-slate-800 dark:text-neutral-100 overflow-x-hidden relative">
            ...
            <div className="flex-1 flex flex-col min-h-screen w-full md:pl-[240px]">
                <header className="h-[72px] w-full bg-white dark:bg-neutral-900 border-b border-slate-200 dark:border-neutral-800 flex items-center justify-between px-4 md:px-8 sticky top-0 z-30">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="font-bold text-lg text-slate-800 dark:text-neutral-100">{editing ? 'Edit Profile' : 'Patient Profile'}</div>
                    </div>
                    <div className="flex items-center gap-3">
                        <ThemeToggle />
                        <button onClick={() => window.history.back()} className="px-4 py-2 bg-slate-100 dark:bg-neutral-800 text-slate-600 dark:text-neutral-400 text-xs font-bold rounded-lg hover:bg-slate-200 dark:hover:bg-neutral-700 transition-colors">← Back</button>
                    </div>
                </header>
