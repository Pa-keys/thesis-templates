...
export function LoadingState({ label = 'Loading...', className = '' }: LoadingStateProps) {
    return (
        <div role="status" aria-live="polite" aria-busy="true" className={cn('flex min-w-0 max-w-full flex-col gap-3 rounded-lg border border-[#DDE7EF] bg-[#F8FAFC] px-4 py-5 sm:px-5', className)}>
